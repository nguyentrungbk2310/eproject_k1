	...
	<div class="container conversion-chart">
		...
		<div class="row">
			<div class="col-sm-4">
				<div class="panel panel-primary">
					<div class="panel-heading text-center" >
						<a href="#" style="color: white;"><h3>Area</h3></a>
					</div>
			...
			<div class="col-sm-4">	
				<div class="panel panel-primary">
					<div class="panel-heading text-center">
						<a href="#" style="color: white;"><h3>Length</h3></a>
					</div>
					<div class="panel-body">
			...
			<div class="col-sm-4">
				<div class="panel panel-primary">
					<div class="panel-heading text-center">
						<a href="#" style="color: white;"><h3>Volume</h3></a>
					</div>
					<div class="panel-body">
		...
		<div class="row">
			<div class="col-sm-4">
				<div class="panel panel-primary">
					<div class="panel-heading text-center">
						<a href="#" style="color: white;"><h3>Mass</h3></a>
					</div>
					<div class="panel-body">
			...
			<div class="col-sm-4">
				<div class="panel panel-primary">
					<div class="panel-heading text-center">
						<a href="#" style="color: white"><h3>Temperature</h3></a>
					</div>
					<div class="panel-body">
			...
			<div class="col-sm-4">
				<div class="panel panel-primary">
					<div class="panel-heading text-center">
						<a href="#" style="color: white"><h3>Currency</h3></a>
					</div>
					<div class="panel-body">
		...
		<div id="myCarousel" class="carousel slie" data-ride = "carousel">
		  ...
		  <div class="carousel-inner">
		  	<div class="item active">
		  		<img src="https://i.9mobi.vn/cf/images/2015/03/nkk/nhung-hinh-anh-dep-20.jpg" style="width: 100%;">
