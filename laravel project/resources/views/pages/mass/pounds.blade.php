	...
	<div class="row">
		...
		<div class="col-sm-9">
			...
			<div>
				<h2>Pounds</h2>
				<p>
					Is a unit of currency in some nations. The term originated in the Frankish Empire as a result of Charlemagne's currency reform ("pound" from Latin pondus, a unity of weight) and was subsequently taken to Great Britain as the value of a pound (weight) of silver 
				</p>
				<p>	
