...
@section('NoiDung')
	...
	<div class="row">
		...
		<div class="col-sm-9">
			...
			<div>
				<h2>Square milimeters</h2>
				<p>
					Square milimeters is a unit defined as a square with each side measuring one millimeter in length. This is abbreviated simply as mm2.
				</p>
			</div>
		</div>
	</div>
