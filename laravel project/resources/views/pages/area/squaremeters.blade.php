...
@section('NoiDung')
	...
	<div class="row">
		...
		<div class="col-sm-9">
			...
			<div>
				<h2>Square meter (or 'metre' with British spelling)</h2>
				<p>
					Square is a square which possesses equal sides of one meter. Otherwise abbreviated as m2. It is often used to measure the area within a room or the total area associated with an exterior parcel of land.
				</p>
			</div>
		</div>
	</div>
