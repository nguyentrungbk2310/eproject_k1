...
@section('NoiDung')
	...
	<div class="row">
		...
		<div class="col-sm-9">
			...
			<div>
				<h2>The square feet</h2>
				<p>
					Squarefeet is used as a form of measurement within Canada and the United States. It can be adopted to describe the amount of floor space (for real estate) or the overall size of an exterior property. One square foot can be translated to 0.092 square metres.
				</p>
			</div>
		</div>
	</div>
