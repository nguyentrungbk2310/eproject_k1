	...
	<div class="row">
		...
		<div class="col-sm-9">
			...
			<div>
				<h2>Feet</h2>
				<p>
					Feet is a unit for measuring length. It is one of the Imperial units and U.S. customary units. The shortest way of writing the unit "foot" is by the abbreviation "ft" (or "ft."). ince 1959, both units have been defined by international agreement as equivalent to 0.3048 meters exactly. The metre is the base unit of length in some metric systems, including the International System of Units (SI). The SI unit symbol is m.[2] The metre is defined as the length of the path travelled by light in a vacuum in 1/299 792 458 second.
				</p>
			</div>
		</div>
	</div>
