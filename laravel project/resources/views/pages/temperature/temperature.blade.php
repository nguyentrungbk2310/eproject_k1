...
@section('NoiDung')
	<div class="banner" style="background-image: url({{ asset('css/images/temperature2.jpg') }}); height: 300px;">
		<div class="banner-box" style="height: 300px;"></div>
		<div class="page-title">
			<h1 style="top: 120px;">Temperature Conversion</h1>
		</div>
	</div>
	{{-- end banner	 --}}
	<div class="row">
		...
		<div class="col-sm-9">
			...
			<div>
				<h2>Temperature</h2>
				<p>
					is a physical quantity expressing hot and cold. It is measured with a thermometer calibrated in one or more temperature scales. The most commonly used scales are the Celsius scale (formerly called centigrade) (denoted °C), Fahrenheit scale (denoted °F),
				</p>
				</p>
			</div>
		</div>
